# -*- coding: utf-8 -*-
"""
Created on Mon Jul 29 08:43:00 2013
...
def load(l, density, snr, M, e, shape):
    ...
    The data generated by this function is fit to the Linear regression + L2
    loss function, i.e.:
...
def _generate(k, density, snr, M, e, shape):
    ...
    e = e / np.sqrt(np.sum(e ** 2.0))  # Never trust the user ;-)
