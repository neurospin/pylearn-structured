...
def load(l, k, g, beta, M, e, snr=None, shape=None, return_grad=False):
    ...
    if return_grad:
        X, y, gradL1, gradL2, gradTV = _generate(l, k, g, beta, M, e, shape,
                                                 return_grad=True)
        return X, y, beta, gradL1, gradL2, gradTV
    else:
        X, y = _generate(l, k, g, beta, M, e, shape, return_grad=False)
        return X, y, beta


def _generate(l, k, g, beta, M, e, shape, return_grad=False):
    ...
    if return_grad:
        return X, y, gradL1, gradL2, gradTV
    else:
        return X, y